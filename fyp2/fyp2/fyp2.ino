...
const char* ssid = "test"; //Update with your wifi name
const char* password = "1234"; //Update with your wifi password
const char* serverAddress = ""; // Update with your server address
